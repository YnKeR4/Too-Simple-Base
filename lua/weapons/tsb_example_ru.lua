...
SWEP.RecoilType 				= 2	-- 0 - обычный универсальный тип отдачи (оружие просто поднимается вверх), 1 - тип отдчачи как в S.T.A.L.K.E.R. (ещё не до конца идеал), 2 - динмаическая отдача (и ViewPunch)
...
-- 0 - нет прицела, 1 - обычный прицел, 2 - прицел как в Колде, 3 - ACOG, 4 - Eotech, 5 - свой прицел (без дугов), 6 - свой прицел (с дугами)
SWEP.CustomScopePath 			= nil	-- путь текстуры прицела, если ты используешь 5 или 6 значение в ScopeTexture, ты можешь удалить это
