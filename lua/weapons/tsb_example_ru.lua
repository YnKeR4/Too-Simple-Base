...
-- 0 - обычный универсальный тип отдачи (оружие просто поднимается вверх), 1 - тип отдчачи как в S.T.A.L.K.E.R. (ещё не до конца идеал)
-- 2 - динмаическая отдача (и ViewPunch), 3 - плавная отдача, 4 - меняет директорию пули (как в ксго или кс2)
